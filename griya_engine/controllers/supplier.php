...
function __construct(){
    ...
    if($this->tank_auth->is_logged_in() ){
        ...
        $this->session->set_flashdata('adminfrom', '/supplier');
...
function browse($page = 1){
	...
	$data['columnHeaders'] = array(
							...
							array('header_title'=>'Nama', 'field_name'=> 'nama', 'width'=>'15%', 'rowinfo' => false),
							array('header_title'=>'Alamat', 'field_name'=> 'alamat', 'width'=>'19%', 'rowinfo' => false),
							array('header_title'=>'Kota', 'field_name'=> 'kota', 'width'=>'11%', 'rowinfo' => false),
							array('header_title'=>'Telepon', 'field_name'=> 'tlp', 'width'=>'11%', 'rowinfo' => false),
							array('header_title'=>'Email', 'field_name'=> 'email', 'width'=>'11%', 'rowinfo' => false),
